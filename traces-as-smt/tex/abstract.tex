...
Our results demonstrate that our SMT encoding reduces $70\%$ clauses of that of the existing technology. In addition, our encoding runs average eight times faster and uses two times less memory than the existing technology on the benchmarks in our experiment.
